...
public class JwtHelper {
    ...
    public JwtHelper(@Value("${accessTokenSecret}") String accessTokenSecret, @Value("${refreshTokenSecret}") String refreshTokenSecret, @Value("${com.example.AuthServer.refreshTokenExpirationDays}") int refreshTokenExpirationDays, @Value("${com.example.AuthServer.accessTokenExpirationMinutes}") int accessTokenExpirationMinutes) {
    ...
    public String generateRefreshToken(AppUser user, RefreshToken refreshToken) {
        return JWT.create()
                .withIssuer(issuer)
                .withSubject(user.getId())
